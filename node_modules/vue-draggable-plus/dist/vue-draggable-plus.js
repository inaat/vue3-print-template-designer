...
var gt = (t, e, n) =>
    e in t
      ? Kt(t, e, { enumerable: !0, configurable: !0, writable: !0, value: n })
      : (t[e] = n),
  se = (t, e) => {
    for (var n in e || (e = {})) mt.call(e, n) && gt(t, n, e[n])
    if (Pe) for (var n of Pe(e)) vt.call(e, n) && gt(t, n, e[n])
    return t
  }
var Ve = (t, e) => {
  var n = {}
  ...
  if (t != null && Pe)
    for (var o of Pe(t)) e.indexOf(o) < 0 && vt.call(t, o) && (n[o] = t[o])
  return n
}
import {
...
function dn(t) {
  return Object.keys(t).reduce(
    (e, n) => (typeof t[n] != 'undefined' && (e[cn(n)] = t[n]), e),
    {}
  )
}
function hn(t, e) {
...
function J(t) {
  for (var e = 1; e < arguments.length; e++) {
    ...
    e % 2
      ? Et(Object(n), !0).forEach(function (o) {
          Sn(t, o, n[o])
        })
      : Object.getOwnPropertyDescriptors
      ? Object.defineProperties(t, Object.getOwnPropertyDescriptors(n))
      : Et(Object(n)).forEach(function (o) {
      ...
      t.forEach(function (l) {
        ...
        w && ((c.top -= w.f), (c.left -= w.e)),
          ...
          u.thisAnimationDuration &&
            qe(v, c) &&
            !qe(d, c) && // Make sure animatingRect is on line between toRect & fromRect
            (b.top - c.top) / (b.left - c.left) ===
              (d.top - c.top) / (d.left - c.left) &&
            (s = xn(b, v, y, r.options)),
          qe(c, d) ||
            ((u.prevFromRect = d),
            (u.prevToRect = c),
...
var f,
  ...
  Fe = Mt,
  It = Ie || te ? 'cssFloat' : 'float',
  Rn = Ue && !Ft && !Mt && 'draggable' in document.createElement('div'),
  Lt = (function () {
    if (Ue) {
      if (te) return !1
...
function p(t, e) {
  ...
  ;(this.nativeDraggable = e.forceFallback ? !1 : Rn),
  ...
  /** @lends Sortable.prototype */
  {
        ...
        if (
          ...
          (s = function () {
            ...
            r._disableDelayedDragEvents(),
              !St && r.nativeDraggable && (f.draggable = !0),
    ...
    _triggerDragStart: function (e, n) {
      ;(n = n || (e.pointerType == 'touch' && e)),
        !this.nativeDraggable || n
          ...
          : (S(f, 'dragend', this), S(_, 'dragstart', this._onDragStart))
      try {
        document.selection
          ? Be(function () {
    ...
    _emulateDragOver: function () {
      if (U) {
        ...
        for (
          var e = document.elementFromPoint(U.clientX, U.clientY), n = e;
          e &&
          e.shadowRoot &&
          ((e = e.shadowRoot.elementFromPoint(U.clientX, U.clientY)), e !== n);
      ...
      if (!m) {
        ...
        ;(m = f.cloneNode(!0)),
          ...
          h(
            m,
            'transform-origin',
            (Ot / parseInt(m.style.width)) * 100 +
              '% ' +
              (Ct / parseInt(m.style.height)) * 100 +
              '%'
          )
      }
    },
    _onDragStart: function (e, n) {
      ...
      Y('setupClone', this),
        ...
        (o.cloneId = Be(function () {
          Y('clone', o),
            !p.eventCanceled &&
              (o.options.removeCloneOnHide || _.insertBefore(T, f),
              o._hideClone(),
              X({
                sortable: o,
                name: 'clone'
        ...
        n
          ...
          : (E(document, 'mouseup', o._onDrop),
            ...
            r &&
              ...
              i.setData && i.setData.call(o, r, f)),
            S(document, 'drop', o),
      ...
      function P(ye) {
        return (
          ...
          ye &&
            ...
            b !== v &&
              (H(f, x ? x.options.ghostClass : u.options.ghostClass, !1),
              H(f, l.ghostClass, !0)),
            x !== b && b !== p.active
              ? (x = b)
              : b === p.active && x && (x = null),
          ...
          !l.dragoverBubble &&
            !e.rootEl &&
            o !== document &&
            (f.parentNode[W]._isOutsideThisEl(e.target), !ye && fe(e)),
      ...
      if (
        ...
        if (a)
          return (
            ...
            this._hideClone(),
            M('revert'),
            p.eventCanceled || (ce ? _.insertBefore(f, ce) : _.appendChild(f)),
            P(!0)
          )
        ...
        if (!F || (Wn(e, y, this) && !F.animated)) {
          ...
          if (
            (F && n === e.target && (o = F),
            o && (i = N(o)),
            Re(_, n, f, r, o, i, e, !!o) !== !1)
          )
            return (
              O(),
              F && F.nextSibling
                ? n.insertBefore(f, F.nextSibling)
                : n.appendChild(f),
              (I = n),
              k(),
              P(!0)
          ...
          var $ = ve(n, 0, l, !0)
          if ($ === f) return P(!1)
          if (((o = $), (i = N(o)), Re(_, n, f, r, o, i, e, !1) !== !1))
            return O(), n.insertBefore(f, $), (I = n), k(), P(!0)
          ...
          var g = 0,
            ...
            B = y ? 'top' : 'left',
            j = _t(o, 'top', 'top') || _t(f, 'top', 'top'),
            ae = j ? j.scrollTop : void 0
          he !== o && ((D = i[B]), (Ce = !1), (Me = (!C && l.invertSwap) || G)),
            (g = Gn(
              e,
              o,
              i,
          ...
          if (g !== 0) {
            var le = z(f)
            do (le -= g), (Z = I.children[le])
            while (Z && (h(Z, 'display') === 'none' || Z === m))
          }
          if (g === 0 || Z === o) return P(!1)
          ;(he = o), (Oe = g)
          ...
          if (Ne !== !1)
            return (
              ...
              j && Bt(j, 0, ae - j.scrollTop),
              (I = f.parentNode),
              D !== void 0 && !Me && (ke = Math.abs(D - N(o)[B])),
              k(),
              P(!0)
            )
        }
        if (n.contains(f)) return P(!1)
      }
      return !1
    },
      ...
      ;(pe = !1),
        ...
        e &&
          ...
          f &&
            ...
            we &&
              !pe &&
              H(f, x ? x.options.ghostClass : this.options.ghostClass, !1),
            H(f, this.options.chosenClass, !1),
            X({
              sortable: this,
              name: 'unchoose',
              toEl: I,
      ...
      for (
        ...
        (n = o[r]),
          q(n, a.draggable, this.el, !1) &&
            e.push(n.getAttribute(a.dataIdAttr) || zn(n))
      return e
    },
    /**
...
function Wn(t, e, n) {
  var o = N(ct(n.el, n.options.draggable)),
    r = Yt(n.el),
    i = 10
  return e
          ...
          ? (($ =
            ...
            (g =
              ...
              (C.overflowY === 'auto' ||
                ...
                C.overflowY === 'visible')))
          : (($ =
              k < D && (C.overflowX === 'auto' || C.overflowX === 'scroll')),
            (g = F < G && (C.overflowY === 'auto' || C.overflowY === 'scroll')))
        var ae =
            $ &&
            (Math.abs(P - r) <= a && B + k < D) - (Math.abs(O - r) <= a && !!B),
          Z =
            g &&
            (Math.abs(M - i) <= a && j + F < G) - (Math.abs(w - i) <= a && !!j)
        if (!A[c]) for (var le = 0; le <= c; le++) A[le] || (A[le] = {})
        ;(A[c].vx != ae || A[c].vy != Z || A[c].el !== y) &&
          ((A[c].el = y),
          (A[c].vx = ae),
          (A[c].vy = Z),
          clearInterval(A[c].pid),
          (ae != 0 || Z != 0) &&
            ((u = !0),
            (A[c].pid = setInterval(
              function () {
                o && this.layer === 0 && p.active._onTouchMove(ze)
                var be = A[this.layer].vy ? A[this.layer].vy * l : 0,
                  ne = A[this.layer].vx ? A[this.layer].vx * l : 0
                ;(typeof d == 'function' &&
                  d.call(
                    p.dragged.parentNode[W],
                    ne,
                    be,
                    t,
                    ze,
...
function Vt(...t) {
  var F, $
  const e = (F = ft()) == null ? void 0 : F.proxy,
    n = t[0]
  let [, o, r] = t
  ...
  function d(g) {
    const D = g.item[Nt]
    gn(D) || ($e(g.item), pn(V(o), g.newDraggableIndex, D))
  }
  function c(g) {
    const {
      from: D,
  ...
  function b(g) {
    const D = V(n)
    return (
      g || (g = mn(D) ? vn(D, e == null ? void 0 : e.$el) : D),
      g && !wn(g) && (g = g.$el),
      g || fn('Root element not found'),
      g
    )
  }
  function w() {
    var C
    const B = (C = V(r)) != null ? C : {},
      { immediate: g, clone: D } = B,
      G = Ve(B, ['immediate', 'clone'])
    return yn(o === null ? {} : y, G)
  }
  const M = g => {
  ...
  const O = {
    ...
    P = () => (O == null ? void 0 : O.option('disabled', !0)),
    k = () => (O == null ? void 0 : O.option('disabled', !1))
  return (
    Kn(() => {
      a && M()
    }),
    qn(O.destroy),
    se({ start: M, pause: P, resume: k }, O)
  )
}
const ut = [
    'update',
      ...
      const i = ut.reduce((d, c) => {
        ...
        a = bt(() => {
          const y = on(t),
            { modelValue: d } = y,
            c = Ve(y, ['modelValue']),
            v = Object.entries(c).reduce((b, [w, M]) => {
              const O = V(M)
  ...
  no = {
    [Pt.mounted](t, e) {
      const n = sn(e.value) ? [e.value] : e.value,
        o = Vt(t, ...n)
      rt.set(t, o.destroy)
    },
    [Pt.unmounted](t) {
...
export { to as VueDraggable, Vt as useDraggable, no as vDraggable }
